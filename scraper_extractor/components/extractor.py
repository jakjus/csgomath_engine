...
class Extractor:
    ...
    keys_off_market = [
            {'name': 'Fracture Case Key', 'asset_description': {'icon_url': 'https://static.wikia.nocookie.net/cswikia/images/2/2a/Fracture_Case_Key.png', 'descriptions': [{'value':'This key opens only Fracture Cases'}]}},
            {'name': 'Dreams & Nightmares Case Key', 'asset_description': {'icon_url': 'https://static.wikia.nocookie.net/cswikia/images/2/21/Crate_key_community_30.png', 'descriptions': [{'value':'This key opens only Dreams & Nightmares Cases'}]}},
            {'name': 'Shattered Web Case Key', 'asset_description': {'icon_url': 'https://static.wikia.nocookie.net/cswikia/images/2/2f/Shattered_Web_Case_Key.png', 'descriptions': [{'value':'This key opens only Shattered Web Cases'}]}},
            {'name': 'Snakebite Case Key', 'asset_description': {'icon_url': 'https://static.wikia.nocookie.net/cswikia/images/5/51/Snakebite-case-key.png', 'descriptions': [{'value':'This key opens only Snakebite Cases'}]}}
            ]
